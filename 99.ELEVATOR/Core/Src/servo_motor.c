...
void servo_motor_main(void)
{
	...
	while(1)
	{
		__HAL_TIM_SET_COMPARE(&htim5, TIM_CHANNEL_2,120); //180
		HAL_Delay(1000);

		__HAL_TIM_SET_COMPARE(&htim5, TIM_CHANNEL_2,77);  //90
		HAL_Delay(1000);

		__HAL_TIM_SET_COMPARE(&htim5, TIM_CHANNEL_2,33);  //0		__HAL_TIM_SET_COMPARE(&htim5, TIM_CHANNEL_2,120);
		HAL_Delay(1000);
	}
